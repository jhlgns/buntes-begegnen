...
let typeMap: {[index: string]: any} = {
    ...
    "Activity": Activity,
    "ActivityCreatedDto": ActivityCreatedDto,
    "ActivityDto": ActivityDto,
    "ActivityRecurrenceByDay": ActivityRecurrenceByDay,
    "ActivityRecurrenceByDayDto": ActivityRecurrenceByDayDto,
    "ActivityRecurrenceByMonthDay": ActivityRecurrenceByMonthDay,
    "ActivityRecurrenceDate": ActivityRecurrenceDate,
    "ActivityRecurrenceException": ActivityRecurrenceException,
    "ApiMetadataDto": ApiMetadataDto,
    "ClaimDto": ClaimDto,
    "CreateInquiryDto": CreateInquiryDto,
    "CreateUserDto": CreateUserDto,
    "FieldValidationConstraintDto": FieldValidationConstraintDto,
    "LoginRequestDto": LoginRequestDto,
    "Promoter": Promoter,
    "RegistrationErrorDto": RegistrationErrorDto,
    "RegistrationRequestDto": RegistrationRequestDto,
    "TypeConstraintsDto": TypeConstraintsDto,
    "UpdateActivityDto": UpdateActivityDto,
    "User": User,
    "UserDto": UserDto,
    "UserFavoriteCategory": UserFavoriteCategory,
    "UserProfileDto": UserProfileDto,
    "UserWithRolesDto": UserWithRolesDto,
}
