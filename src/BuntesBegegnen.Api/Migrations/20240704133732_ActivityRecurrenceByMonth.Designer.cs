...
namespace BuntesBegegnen.Api.Migrations
{
    ...
    [Migration("20240704133732_ActivityRecurrenceByMonth")]
    partial class ActivityRecurrenceByMonth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuntesBegegnen.Api.Data.Entities.Activity", b =>
                {
                    ...
                    b.Property<bool>("IsExceptionalDelete")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<DateTimeOffset?>("RepeatFrom")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BuntesBegegnen.Api.Data.Entities.ActivityRecurrenceByMonth", b =>
                {
                    b.Property<int>("ActivityId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("ActivityId", "Month");

                    b.ToTable("ActivityRecurrenceByMonth");
                });
            ...
            modelBuilder.Entity("BuntesBegegnen.Api.Data.Entities.Activity", b =>
                {
                    ...
                    b.HasOne("BuntesBegegnen.Api.Data.Entities.Activity", "ParentActivity")
                        .WithMany()
