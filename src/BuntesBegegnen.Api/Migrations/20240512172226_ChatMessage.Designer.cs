...
namespace BuntesBegegnen.Api.Migrations
{
    ...
    [Migration("20240512172226_ChatMessage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuntesBegegnen.Api.Data.Entities.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BuntesBegegnen.Api.Data.Entities.ChatMessage", b =>
                {
                    b.HasOne("BuntesBegegnen.Api.Data.Entities.User", "Receipient")
                        .WithMany()
                        .HasForeignKey("ReceipientId");

                    b.HasOne("BuntesBegegnen.Api.Data.Entities.User", "Sender")
                        .WithMany()
